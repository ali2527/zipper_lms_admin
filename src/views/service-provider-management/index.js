...

    {
      ...
      render: (value, item, index) => (
        <Select
          ...
          bordered={false}
          onChange={() => {setModalOpen(true); setSelectedUser(serviceProviders[index])}}
          options={[
            {
              value: "active",
              label: "Activate",
      ...
      render: (item) => (
        <FaEye
          style={{ fontSize: "16px", color: "#203453",  cursor: "pointer" }}
             onClick={() => navigate("/service-provider-management/" + item )}
        />
      ),
    },
  ];
    ...
    <Layout className="configuration">
      <div className="boxDetails">
        <Row style={{ padding: "10px 20px" }}>
          <h1 className="pageTitle">Service Provider Management</h1>
        </Row>
