...
function BookingAndPaymentDetails() {
  ...
  const handlePageChange = (pageNumber) => {
    ...
    getBookingAndPaymentDetails(pageNumber);
  };
  ...
  const resetFilter = () => {
    ...
    getBookingAndPaymentDetails(paginationConfig.pageNumber, paginationConfig.limit, "", true);
  };
  ...
  const handleLimitChange = (pageSize) => {
    ...
    getBookingAndPaymentDetails(1, pageSize);
  };
  ...
  const getBookingAndPaymentDetails = async (pageNumber, pageSize, search, reset = false) => {
    setLoading(true);
    try {
    ...
    <div className="filterDropdown">
      ...
      <div className="filterDropdownBody">
        ...
        <Button
          ...
          onClick={() => getBookingAndPaymentDetails()}
        >
          Apply
        </Button>
        <Button
  ...
  return (
    <Layout className="configuration">
      ...
      <Row style={{ padding: "10px 20px" }}>
          ...
          >
            <h1 className="pageTitle">BookingAndPaymentDetails</h1>
          </Col>
          <Col
            xs={24}
            md={12}
          ...
          >
            <h1 className="pageTitle" style={{}}>Total Amount: </h1>
          </Col>
        </Row>
        <Row style={{ padding: "10px 20px" }}>
          <Col xs={24} md={12}>
            ...
            <Input
              ...
              suffix={
                <FaSearch
                  ...
                  onClick={() =>
                    getBookingAndPaymentDetails(1, paginationConfig.limit, filter.keyword)
                  }
                />
              }
              onPressEnter={(e) =>
...
export default BookingAndPaymentDetails;
